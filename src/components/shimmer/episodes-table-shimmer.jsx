        ...
        <tr key={index} className="border-b border-border">
          <td className="p-4">
            <div className="space-y-2">
              ...
              <div className="h-3 w-64 bg-teal-400/10 rounded animate-pulse"></div>
            </div>
          </td>
          <td className="p-4">
          ...
          <td className="p-4">
            <div className="space-y-2">
              <div className="h-6 w-24 bg-teal-400/10 rounded animate-pulse"></div>
              <div className="h-3 w-20 bg-teal-400/10 rounded animate-pulse"></div>
            </div>
          </td>
          <td className="p-4">
            <div className="h-5 w-16 bg-teal-400/10 rounded animate-pulse"></div>
          </td>
          <td className="p-4">
