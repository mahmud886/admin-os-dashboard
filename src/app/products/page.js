          ...
          <Card className="bg-[#111111] border-border">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  id="name"
                  placeholder="e.g. Neural Link Tee"
          ...
          <Card className="bg-[#111111] border-border">
            ...
            <CardContent className="space-y-6">
              <div className="space-y-2">
                ...
                <Button
                  variant="outline"
                  className="w-full bg-[#0a0a0a] border-border"
                >
                  SELECT FROM LIBRARY
                </Button>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="mt-2 text-lg font-medium text-teal-400">
                    {productsData.stockStatus.currentStock}
                  </div>
                </div>
              </div>
            </CardContent>
