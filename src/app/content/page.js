            ...
            {contentData.pages.map((page) => (
              ...
              >
                <div className="flex items-center justify-between">
                  <span
                    className={`font-medium ${selectedPage === page.id ? "text-teal-400" : "text-gray-400"}`}
                  >
                    {page.name}
                  </span>
                  <Badge
        ...
        <Card className="lg:col-span-2 bg-[#111111] border-border">
          <CardHeader>
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-lg sm:text-xl text-teal-400">
                  LANDING PAGE EDITOR
                </CardTitle>
              </div>
          ...
          <CardContent className="space-y-6">
            <div className="space-y-2">
              ...
              <Input
                defaultValue={landingData.heroHeadline}
            ...
            <div className="space-y-2">
              ...
              <Input
                defaultValue={landingData.ctaLink}
                className="bg-[#0a0a0a] border-border"
              />
            </div>
          </CardContent>
